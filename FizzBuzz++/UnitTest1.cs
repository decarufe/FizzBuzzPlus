...
namespace FizzBuzz
{
    public class UnitTest1
    {
        ...
        {
            private static readonly List<IGenerator> AllGenerators = new List<IGenerator>()
            {
            ...
            public IEnumerator<object[]> GetEnumerator() => AllGenerators.Select(a => new object[] { a }).GetEnumerator();
        ...
        public void Test1(IGenerator generator)
        {
            _list.Clear();
            generator.Generate(100);
            _list.Should().BeEquivalentTo(_100FizzBuzz);
        }
    }
}
